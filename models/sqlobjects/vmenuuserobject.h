#ifndef VMENUUSEROBJECT_H
#define VMENUUSEROBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VMenuUserObject : public TSqlObject, public QSharedData
{
public:
    ...
    QString tableName() const override { return QLatin1String("v_menu_user"); }
