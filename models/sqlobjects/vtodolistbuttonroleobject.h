#ifndef VTODOLISTBUTTONROLEOBJECT_H
#define VTODOLISTBUTTONROLEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VTodoListButtonRoleObject : public TSqlObject, public QSharedData
{
public:
    int role_id {0};
    ...
    QString tableName() const override { return QLatin1String("v_todo_list_button_role"); }
...
#endif // VTODOLISTBUTTONROLEOBJECT_H
