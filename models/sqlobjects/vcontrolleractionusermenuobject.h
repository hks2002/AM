#ifndef VCONTROLLERACTIONUSERMENUOBJECT_H
#define VCONTROLLERACTIONUSERMENUOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionUserMenuObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
