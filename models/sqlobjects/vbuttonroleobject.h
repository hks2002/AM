#ifndef VBUTTONROLEOBJECT_H
#define VBUTTONROLEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VButtonRoleObject : public TSqlObject, public QSharedData
{
public:
    int button_id {0};
    QString button_cd;
    ...
    QString tableName() const override { return QLatin1String("v_button_role"); }
