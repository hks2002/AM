#ifndef VCONTROLLERACTIONROLETABOBJECT_H
#define VCONTROLLERACTIONROLETABOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionRoleTabObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_role_tab"); }
...
#endif // VCONTROLLERACTIONROLETABOBJECT_H
