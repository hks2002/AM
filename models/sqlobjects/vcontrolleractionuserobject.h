#ifndef VCONTROLLERACTIONUSEROBJECT_H
#define VCONTROLLERACTIONUSEROBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionUserObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_user"); }
...
#endif // VCONTROLLERACTIONUSEROBJECT_H
