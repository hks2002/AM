#ifndef VCONTROLLERACTIONROLEALLOBJECT_H
#define VCONTROLLERACTIONROLEALLOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionRoleAllObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_role_all"); }
...
#endif // VCONTROLLERACTIONROLEALLOBJECT_H
