#ifndef VTODOLISTTABOBJECT_H
#define VTODOLISTTABOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VTodoListTabObject : public TSqlObject, public QSharedData
{
public:
    int todo_list_id {0};
...
public slots:
    ...
    QString tableName() const override { return QLatin1String("v_todo_list_tab"); }
