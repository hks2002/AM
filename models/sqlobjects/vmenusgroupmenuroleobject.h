#ifndef VMENUSGROUPMENUROLEOBJECT_H
#define VMENUSGROUPMENUROLEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VMenusGroupMenuRoleObject : public TSqlObject, public QSharedData
{
public:
    int role_id {0};
    ...
    QString tableName() const override { return QLatin1String("v_menus_group_menu_role"); }
...
#endif // VMENUSGROUPMENUROLEOBJECT_H
