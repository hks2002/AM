#ifndef VCONTROLLERACTIONROLEBUTTONOBJECT_H
#define VCONTROLLERACTIONROLEBUTTONOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionRoleButtonObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_role_button"); }
...
#endif // VCONTROLLERACTIONROLEBUTTONOBJECT_H
