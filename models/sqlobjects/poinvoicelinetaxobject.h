#ifndef POINVOICELINETAXOBJECT_H
#define POINVOICELINETAXOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT PoInvoiceLineTaxObject : public TSqlObject, public QSharedData
{
public:
...
public slots:
    ...
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<TaxId<<PoInvoiceLineId; }
    QString tableName() const override { return QLatin1String("po_invoice_line_tax"); }
...
#endif // POINVOICELINETAXOBJECT_H
