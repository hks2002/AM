#ifndef TASKSCHEDRULEPARTOBJECT_H
#define TASKSCHEDRULEPARTOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT TaskSchedRulePartObject : public TSqlObject, public QSharedData
{
public:
    int task_id {0};
    int data_type_id {0};
    ...
    QList<int> primaryKeyIndexList() const override { QList<int> pkidxList; return pkidxList<<TaskId<<DataTypeId<<PartNoId; }
    int autoValueIndex() const override { return -1; }
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<PartNoId<<DataTypeId<<TaskId; }
    QString tableName() const override { return QLatin1String("task_sched_rule_part"); }
...
#endif // TASKSCHEDRULEPARTOBJECT_H
