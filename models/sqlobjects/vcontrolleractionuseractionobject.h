#ifndef VCONTROLLERACTIONUSERACTIONOBJECT_H
#define VCONTROLLERACTIONUSERACTIONOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionUserActionObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
...
public slots:
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_user_action"); }
...
#endif // VCONTROLLERACTIONUSERACTIONOBJECT_H
