#ifndef MANUFACTATTACHMENTOBJECT_H
#define MANUFACTATTACHMENTOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT ManufactAttachmentObject : public TSqlObject, public QSharedData
{
public:
    int manufact_attachment_id {0};
    int manufact_id {0};
...
public slots:
    QList<int> primaryKeyIndexList() const override { QList<int> pkidxList; return pkidxList<<ManufactAttachmentId; }
    int autoValueIndex() const override { return ManufactAttachmentId; }
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<FileSaveCd<<ManufactId; }
    QString tableName() const override { return QLatin1String("manufact_attachment"); }

private:    /*** Don't modify below this line ***/
    Q_OBJECT
    Q_PROPERTY(int manufact_attachment_id READ getmanufact_attachment_id WRITE setmanufact_attachment_id)
    T_DEFINE_PROPERTY(int, manufact_attachment_id)
...
#endif // MANUFACTATTACHMENTOBJECT_H
