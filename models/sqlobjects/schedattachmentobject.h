#ifndef SCHEDATTACHMENTOBJECT_H
#define SCHEDATTACHMENTOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT SchedAttachmentObject : public TSqlObject, public QSharedData
{
public:
    int sched_attachment_id {0};
    int sched_id {0};
    ...
    QList<int> primaryKeyIndexList() const override { QList<int> pkidxList; return pkidxList<<SchedAttachmentId; }
    int autoValueIndex() const override { return SchedAttachmentId; }
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<FileSaveCd<<SchedId; }
    QString tableName() const override { return QLatin1String("sched_attachment"); }

private:    /*** Don't modify below this line ***/
    Q_OBJECT
    Q_PROPERTY(int sched_attachment_id READ getsched_attachment_id WRITE setsched_attachment_id)
    T_DEFINE_PROPERTY(int, sched_attachment_id)
