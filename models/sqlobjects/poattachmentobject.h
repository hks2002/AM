#ifndef POATTACHMENTOBJECT_H
#define POATTACHMENTOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT PoAttachmentObject : public TSqlObject, public QSharedData
{
public:
    int po_attachment_id {0};
    int po_id {0};
...
public slots:
    QList<int> primaryKeyIndexList() const override { QList<int> pkidxList; return pkidxList<<PoAttachmentId; }
    int autoValueIndex() const override { return PoAttachmentId; }
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<FileSaveCd<<PoId; }
    QString tableName() const override { return QLatin1String("po_attachment"); }

private:    /*** Don't modify below this line ***/
    Q_OBJECT
    Q_PROPERTY(int po_attachment_id READ getpo_attachment_id WRITE setpo_attachment_id)
    T_DEFINE_PROPERTY(int, po_attachment_id)
