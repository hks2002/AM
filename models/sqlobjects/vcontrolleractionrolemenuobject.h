#ifndef VCONTROLLERACTIONROLEMENUOBJECT_H
#define VCONTROLLERACTIONROLEMENUOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionRoleMenuObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_role_menu"); }
...
#endif // VCONTROLLERACTIONROLEMENUOBJECT_H
