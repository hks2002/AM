#ifndef VTODOLISTBUTTONUSEROBJECT_H
#define VTODOLISTBUTTONUSEROBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VTodoListButtonUserObject : public TSqlObject, public QSharedData
{
public:
    int user_id {0};
...
public slots:
    ...
    QString tableName() const override { return QLatin1String("v_todo_list_button_user"); }
...
#endif // VTODOLISTBUTTONUSEROBJECT_H
