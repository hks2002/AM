#ifndef VCONTROLLERACTIONUSERALLOBJECT_H
#define VCONTROLLERACTIONUSERALLOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionUserAllObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_user_all"); }
...
#endif // VCONTROLLERACTIONUSERALLOBJECT_H
