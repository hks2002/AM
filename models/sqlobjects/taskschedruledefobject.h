#ifndef TASKSCHEDRULEDEFOBJECT_H
#define TASKSCHEDRULEDEFOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT TaskSchedRuleDefObject : public TSqlObject, public QSharedData
{
public:
    int task_id {0};
    int data_type_id {0};
    ...
    QList<int> primaryKeyIndexList() const override { QList<int> pkidxList; return pkidxList<<TaskId<<DataTypeId; }
    int autoValueIndex() const override { return -1; }
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<DataTypeId<<TaskId; }
    QString tableName() const override { return QLatin1String("task_sched_rule_def"); }
...
#endif // TASKSCHEDRULEDEFOBJECT_H
