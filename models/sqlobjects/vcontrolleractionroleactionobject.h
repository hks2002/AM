#ifndef VCONTROLLERACTIONROLEACTIONOBJECT_H
#define VCONTROLLERACTIONROLEACTIONOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionRoleActionObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
