#ifndef VTABROLEOBJECT_H
#define VTABROLEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VTabRoleObject : public TSqlObject, public QSharedData
{
public:
    int tab_id {0};
    QString tab_cd;
    ...
    QString tableName() const override { return QLatin1String("v_tab_role"); }
