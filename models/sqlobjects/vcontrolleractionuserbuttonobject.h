#ifndef VCONTROLLERACTIONUSERBUTTONOBJECT_H
#define VCONTROLLERACTIONUSERBUTTONOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VControllerActionUserButtonObject : public TSqlObject, public QSharedData
{
public:
    QString controller;
    QString action;
...
public slots:
    ...
    QString tableName() const override { return QLatin1String("v_controller_action_user_button"); }
...
#endif // VCONTROLLERACTIONUSERBUTTONOBJECT_H
