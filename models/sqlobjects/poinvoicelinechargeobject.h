#ifndef POINVOICELINECHARGEOBJECT_H
#define POINVOICELINECHARGEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT PoInvoiceLineChargeObject : public TSqlObject, public QSharedData
{
public:
...
public slots:
    ...
    QList<int> foreignKeyIndexList() const { QList<int> fkIdxList;return fkIdxList<<ChargeId<<PoInvoiceLineId; }
    QString tableName() const override { return QLatin1String("po_invoice_line_charge"); }
...
#endif // POINVOICELINECHARGEOBJECT_H
