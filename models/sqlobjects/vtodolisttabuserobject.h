#ifndef VTODOLISTTABUSEROBJECT_H
#define VTODOLISTTABUSEROBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VTodoListTabUserObject : public TSqlObject, public QSharedData
{
public:
    int user_id {0};
...
public slots:
    ...
    QString tableName() const override { return QLatin1String("v_todo_list_tab_user"); }
...
#endif // VTODOLISTTABUSEROBJECT_H
