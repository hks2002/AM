#ifndef VMENUSGROUPMENUOBJECT_H
#define VMENUSGROUPMENUOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT VMenusGroupMenuObject : public TSqlObject, public QSharedData
{
public:
...
public slots:
    ...
    QString tableName() const override { return QLatin1String("v_menus_group_menu"); }
