...
HEADERS += sqlobjects/vcontrolleractionallobject.h
HEADERS += sqlobjects/vcontrolleractionroleactionobject.h
HEADERS += sqlobjects/vcontrolleractionroleallobject.h
HEADERS += sqlobjects/vcontrolleractionrolebuttonobject.h
HEADERS += sqlobjects/vcontrolleractionrolemenuobject.h
HEADERS += sqlobjects/vcontrolleractionroletabobject.h
HEADERS += sqlobjects/vcontrolleractionroleuserobject.h
HEADERS += sqlobjects/vcontrolleractionuseractionobject.h
HEADERS += sqlobjects/vcontrolleractionuserallobject.h
HEADERS += sqlobjects/vcontrolleractionuserbuttonobject.h
HEADERS += sqlobjects/vcontrolleractionusermenuobject.h
HEADERS += sqlobjects/vcontrolleractionusertabobject.h
HEADERS += sqlobjects/vendoraccountobject.h
HEADERS += sqlobjects/vendorattachmentobject.h
HEADERS += sqlobjects/vendorobject.h
HEADERS += sqlobjects/vmenusgroupmenuobject.h
HEADERS += sqlobjects/vmenusgroupmenuroleobject.h
HEADERS += sqlobjects/vmenusgroupmenuuserobject.h
HEADERS += sqlobjects/vroleuserobject.h
HEADERS += sqlobjects/vtodolistbuttonobject.h
HEADERS += sqlobjects/vtodolistbuttonroleobject.h
HEADERS += sqlobjects/vtodolistbuttonuserobject.h
HEADERS += sqlobjects/vtodolisttabobject.h
HEADERS += sqlobjects/vtodolisttabroleobject.h
HEADERS += sqlobjects/vtodolisttabuserobject.h
...
HEADERS += userskill.h
HEADERS += vcontrolleractionall.h
HEADERS += vcontrolleractionroleaction.h
HEADERS += vcontrolleractionroleall.h
HEADERS += vcontrolleractionrolebutton.h
HEADERS += vcontrolleractionrolemenu.h
HEADERS += vcontrolleractionroletab.h
HEADERS += vcontrolleractionroleuser.h
HEADERS += vcontrolleractionuseraction.h
HEADERS += vcontrolleractionuserall.h
HEADERS += vcontrolleractionuserbutton.h
HEADERS += vcontrolleractionusermenu.h
HEADERS += vcontrolleractionusertab.h
HEADERS += vendor.h
HEADERS += vendoraccount.h
HEADERS += vendorattachment.h
HEADERS += vmenusgroupmenu.h
HEADERS += vmenusgroupmenurole.h
HEADERS += vmenusgroupmenuuser.h
HEADERS += vroleuser.h
HEADERS += vtodolistbutton.h
HEADERS += vtodolistbuttonrole.h
HEADERS += vtodolistbuttonuser.h
HEADERS += vtodolisttab.h
HEADERS += vtodolisttabrole.h
HEADERS += vtodolisttabuser.h
...
SOURCES += vcontrolleractionall.cpp
SOURCES += vcontrolleractionroleaction.cpp
SOURCES += vcontrolleractionroleall.cpp
SOURCES += vcontrolleractionrolebutton.cpp
SOURCES += vcontrolleractionrolemenu.cpp
SOURCES += vcontrolleractionroletab.cpp
SOURCES += vcontrolleractionroleuser.cpp
SOURCES += vcontrolleractionuseraction.cpp
SOURCES += vcontrolleractionuserall.cpp
SOURCES += vcontrolleractionuserbutton.cpp
SOURCES += vcontrolleractionusermenu.cpp
SOURCES += vcontrolleractionusertab.cpp
SOURCES += vendor.cpp
SOURCES += vendoraccount.cpp
SOURCES += vendorattachment.cpp
SOURCES += vmenusgroupmenu.cpp
SOURCES += vmenusgroupmenurole.cpp
SOURCES += vmenusgroupmenuuser.cpp
SOURCES += vroleuser.cpp
SOURCES += vtodolistbutton.cpp
SOURCES += vtodolistbuttonrole.cpp
SOURCES += vtodolistbuttonuser.cpp
SOURCES += vtodolisttab.cpp
SOURCES += vtodolisttabrole.cpp
SOURCES += vtodolisttabuser.cpp
