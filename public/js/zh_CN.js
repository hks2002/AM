...
if (mini.MessageBox) {
    ...
    mini.AjaxMsgDefault="发生错误";
    mini.AjaxMsgTimeOut="访问超时";
    mini.AjaxMsg404="页面未找到";
    mini.AjaxMsg403="禁止访问";
    mini.AjaxMsg500="服务器错误";
};
if (mini.Calendar) {
...
am.Cancel="取消";
am.Assign="分配";
am.PleaseSelcetOneRecord="请选择一条记录";
am.PleaseSelcetOnlyOneRecord="请至少选择一条记录";
am.PleaseSelcetAtLeastOneRecord="请至少选择一条记录";